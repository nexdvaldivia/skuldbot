...
export const nodeTemplates: NodeTemplate[] = [
  ...
  },
  {
    ...
    icon: 'ListOrdered',
    defaultConfig: {},
    configSchema: [{ name: 'queue_name', label: 'Queue Name', type: 'text', required: true }],
    outputSchema: [
    ...
    outputSchema: [
      {
        ...
        example: '{"nombre": "Juan", "email": "j@mail.com"}',
      },
  ...
  },
  {
    ...
    configSchema: [
      ...
      {
        name: 'condition',
        label: 'Trigger Condition (JSONPath)',
        type: 'text',
  ...
  },
  {
    ...
    configSchema: [
      ...
      { name: 'prefix', label: 'Path Prefix', type: 'text', placeholder: 'uploads/' },
      {
        ...
        options: [
          { value: 'ObjectCreated', label: 'Object Created' },
          { value: 'ObjectRemoved', label: 'Object Removed' },
          { value: 'ObjectModified', label: 'Object Modified' },
        ],
      },
    ...
    configSchema: [
      ...
      },
      {
        ...
        options: [
          ...
          { value: 'webkit', label: 'WebKit (Safari/macOS)' },
        ],
      },
      {
        name: 'headless',
        label: 'Headless Mode (invisible browser)',
        type: 'boolean',
        default: false,
      },
      {
        name: 'allow_fallback',
        label: 'Allow Browser Fallback',
        type: 'boolean',
        default: false,
        description:
          'When disabled, execution fails if requested browser is unavailable or mismatched',
      },
      {
        name: 'fallback_order',
        ...
        type: 'text',
        default: 'auto',
        placeholder: 'auto | edge,chromium,firefox | ["edge","chromium"]',
        description: 'Used only when fallback is enabled',
      },
    ],
    outputSchema: [
  ...
  },
  {
    ...
    outputSchema: [{ name: 'text', type: 'string', description: 'Extracted text content' }],
  },
  {
    ...
    outputSchema: [{ name: 'value', type: 'string', description: 'Attribute value' }],
  },
  {
    type: 'web.screenshot',
    needsStorageConnection: true,
  ...
  },
  {
    ...
    outputSchema: [{ name: 'result', type: 'any', description: 'Return value from JavaScript' }],
  },
  {
    type: 'web.scroll',
    category: 'web',
    ...
    configSchema: [
      {
        ...
        options: [
          ...
          { value: 'up', label: 'Up' },
          { value: 'to_element', label: 'To Element' },
        ],
      },
      {
        name: 'selectorType',
  ...
  },
  {
    ...
    icon: 'PanelLeft',
    defaultConfig: {},
    configSchema: [{ name: 'tab_index', label: 'Tab Index', type: 'number', default: 0 }],
  },
  {
  ...
  },
  {
    ...
    icon: 'Copy',
    defaultConfig: {},
    configSchema: [{ name: 'text', label: 'Text', type: 'text', required: true }],
  },
  ...
  // --- Storage Provider Config Node ---
  {
    ...
    description:
      'Configure storage backend (Local, S3, Azure, GCS, SFTP, SharePoint, OneDrive, Google Drive)',
    icon: 'Database',
    ...
    configSchema: [
      ...
      // --- Local Filesystem ---
      {
        ...
        type: 'text',
        required: true,
        visibleWhen: { field: 'provider', value: 'local' },
        placeholder: '/data/files or C:\\Data\\Files',
      ...
      // --- AWS S3 / MinIO ---
      {
        ...
        type: 'text',
        required: true,
        visibleWhen: { field: 'provider', value: ['s3', 'minio'] },
      ...
      },
      {
        ...
        type: 'select',
        default: 'us-east-1',
        visibleWhen: { field: 'provider', value: 's3' },
        options: [
      ...
      },
      {
        ...
        type: 'text',
        visibleWhen: { field: 'provider', value: ['s3', 'minio'] },
        placeholder: 'https://minio.company.com:9000',
        description: 'For S3-compatible services',
      },
      {
        name: 'access_key',
        label: 'Access Key ID',
        type: 'text',
        visibleWhen: { field: 'provider', value: ['s3', 'minio'] },
        placeholder: '${vault.aws_access_key}',
        supportsExpressions: true,
      },
      {
        name: 'secret_key',
        ...
        type: 'password',
        visibleWhen: { field: 'provider', value: ['s3', 'minio'] },
        placeholder: '${vault.aws_secret_key}',
        supportsExpressions: true,
      },
      {
        name: 'encryption',
      ...
      },
      {
        ...
        label: 'KMS Key ID',
        type: 'text',
        visibleWhen: { field: 'encryption', value: 'SSE-KMS' },
      ...
      // --- Azure Blob Storage ---
      {
        ...
        type: 'text',
        required: true,
        visibleWhen: { field: 'provider', value: 'azure_blob' },
      ...
      },
      {
        ...
        type: 'password',
        visibleWhen: { field: 'provider', value: 'azure_blob' },
        placeholder: '${vault.azure_connection_string}',
        supportsExpressions: true,
      ...
      },
      {
        ...
        description: 'If not using connection string',
      },
      {
        name: 'account_key',
        label: 'Account Key',
        type: 'password',
        visibleWhen: { field: 'provider', value: 'azure_blob' },
        placeholder: '${vault.azure_account_key}',
        supportsExpressions: true,
      },
      {
        name: 'sas_token',
        ...
        description: 'Alternative to account key',
      },
      ...
      // --- Google Cloud Storage ---
      {
        ...
        type: 'text',
        required: true,
        visibleWhen: { field: 'provider', value: 'gcs' },
      ...
      },
      {
        ...
        description: 'Paste service account key JSON',
      },
      ...
      // --- Microsoft SharePoint ---
      {
        ...
        type: 'text',
        required: true,
        visibleWhen: { field: 'provider', value: 'sharepoint' },
      ...
      },
      {
        ...
        type: 'text',
        visibleWhen: { field: 'provider', value: 'sharepoint' },
        placeholder: '${vault.sp_tenant_id}',
        supportsExpressions: true,
      },
      {
        name: 'sp_client_id',
        ...
        type: 'text',
        visibleWhen: { field: 'provider', value: 'sharepoint' },
        placeholder: '${vault.sp_client_id}',
        supportsExpressions: true,
      },
      {
        ...
        type: 'password',
        visibleWhen: { field: 'provider', value: 'sharepoint' },
        placeholder: '${vault.sp_client_secret}',
        supportsExpressions: true,
      },
      {
        name: 'sp_library',
      ...
      // --- Microsoft OneDrive ---
      {
        ...
        label: 'Tenant ID',
        type: 'text',
        visibleWhen: { field: 'provider', value: 'onedrive' },
        placeholder: '${vault.od_tenant_id}',
        supportsExpressions: true,
      },
      {
        name: 'od_client_id',
        ...
        type: 'text',
        visibleWhen: { field: 'provider', value: 'onedrive' },
        placeholder: '${vault.od_client_id}',
        supportsExpressions: true,
      },
      {
        name: 'od_client_secret',
        label: 'Client Secret',
        type: 'password',
        visibleWhen: { field: 'provider', value: 'onedrive' },
        placeholder: '${vault.od_client_secret}',
        supportsExpressions: true,
      },
      {
        name: 'od_user_email',
        ...
        description: 'For delegated access',
      },

      // --- Google Drive ---
      {
        name: 'gd_credentials_json',
        label: 'Service Account JSON',
        type: 'textarea',
        visibleWhen: { field: 'provider', value: 'google_drive' },
        placeholder: '{"type": "service_account", ...}',
      },
      {
        name: 'gd_folder_id',
      ...
      // --- SFTP ---
      {
        ...
        type: 'text',
        required: true,
        visibleWhen: { field: 'provider', value: 'sftp' },
      ...
      },
      {
        ...
        type: 'password',
        visibleWhen: { field: 'provider', value: 'sftp' },
        placeholder: '${vault.sftp_pass}',
        supportsExpressions: true,
        description: 'Or use private key below',
      },
      {
      ...
      },
      {
        ...
        type: 'password',
        visibleWhen: { field: 'provider', value: 'sftp' },
        placeholder: '${vault.sftp_passphrase}',
        supportsExpressions: true,
      },
      ...
      // --- FTP ---
      {
        ...
        type: 'text',
        required: true,
        visibleWhen: { field: 'provider', value: 'ftp' },
      ...
      // --- WebDAV ---
      {
        ...
        type: 'text',
        required: true,
        visibleWhen: { field: 'provider', value: 'webdav' },
        placeholder: 'https://dav.company.com/files/',
      },
      {
      ...
      // --- Common Advanced Options ---
      {
        ...
        description: 'Subdirectory within the bucket/container (optional)',
      },
      {
        name: 'enable_audit',
        ...
        type: 'boolean',
        default: true,
        description: 'Log all file operations for compliance',
      },
      {
        name: 'enable_checksums',
        label: 'Verify Checksums',
        type: 'boolean',
        default: true,
        description: 'SHA-256 integrity verification',
      },
      {
        name: 'chunk_size_mb',
        label: 'Chunk Size (MB)',
        type: 'number',
        default: 8,
        description: 'For streaming large files',
      },
    ],
    outputSchema: [
    ...
    configSchema: [
      {
        ...
        type: 'text',
        required: true,
        description: 'Name of configured source provider',
      },
      {
        name: 'source_path',
        label: 'Source Path',
      ...
      },
      {
        ...
        type: 'text',
        required: true,
        description: 'Name of configured destination provider',
      },
      {
        name: 'dest_path',
  ...
  // --- Directory Sync ---
  {
    ...
    configSchema: [
      ...
      },
      {
        ...
        type: 'boolean',
        default: false,
        description: 'Remove files in destination not in source',
      },
    ],
    outputSchema: [
    ...
    configSchema: [
      {
        ...
        required: true,
        supportsExpressions: true,
        description: 'Connect a Storage Provider for cloud storage',
      },
      {
        name: 'encoding',
        label: 'Encoding',
  ...
  },
  {
    ...
    configSchema: [
      ...
      },
      {
        ...
        description: 'MIME type (for cloud storage)',
      },
  ...
  },
  {
    ...
    configSchema: [
      ...
      { name: 'recursive', label: 'Recursive', type: 'boolean', default: false },
      {
        ...
        type: 'number',
        default: 1000,
        description: 'Limit results (for large directories)',
      },
    ],
    outputSchema: [
  ...
  },
  {
    ...
    configSchema: [
      ...
      },
      {
        ...
        label: 'Password',
        type: 'password',
        placeholder: 'For encrypted ZIPs',
        supportsExpressions: true,
      },
    ],
    outputSchema: [
    ...
    configSchema: [
      {
        ...
        required: true,
        supportsExpressions: true,
        description: 'Requires a cloud Storage Provider connection',
      },
  ...
  // ============================================
  {
    ...
    defaultConfig: {},
    configSchema: [{ name: 'path', label: 'File Path', type: 'text', required: true }],
  },
  {
    ...
    configSchema: [
      ...
      { name: 'header', label: 'First Row as Header', type: 'boolean', default: true },
      {
        ...
        label: 'Column Names',
        type: 'text',
        placeholder: 'Name, Date, Status, Amount',
      },
    ],
    outputSchema: [
      {
        name: 'data',
        type: 'array',
        description: 'Array of rows (objects if header=true or column_names defined)',
      },
  ...
  },
  {
    ...
    outputSchema: [{ name: 'value', type: 'any', description: 'Cell value' }],
  },
  {
  ...
  },
  {
    ...
    icon: 'Save',
    defaultConfig: {},
    configSchema: [{ name: 'path', label: 'Save Path (optional)', type: 'text' }],
  },
  {
    type: 'excel.close',
    category: 'excel',
  ...
  },
  {
    ...
    icon: 'Plus',
    defaultConfig: {},
    configSchema: [{ name: 'name', label: 'Sheet Name', type: 'text', required: true }],
  },
  {
  ...
  },
  {
    ...
    defaultConfig: {},
    configSchema: [],
    outputSchema: [{ name: 'sheets', type: 'array', description: 'List of sheet names' }],
  },
  {
  ...
  },
  {
    ...
    outputSchema: [{ name: 'result', type: 'any', description: 'Found value' }],
  },
  ...
  },
  {
    ...
    icon: 'Trash2',
    defaultConfig: {},
    configSchema: [{ name: 'message_id', label: 'Message ID', type: 'text', required: true }],
  },
  {
  ...
  },
  {
    ...
    defaultConfig: {},
    configSchema: [],
    outputSchema: [{ name: 'folders', type: 'array', description: 'List of folder names' }],
  },
  ...
  },
  {
    ...
    icon: 'Braces',
    defaultConfig: {},
    configSchema: [{ name: 'input', label: 'JSON String', type: 'textarea', required: true }],
  },
  {
    type: 'api.json_path',
    category: 'api',
  ...
  // ============================================
  {
    ...
    configSchema: [
      ...
      },
      {
        ...
        type: 'text',
        required: true,
        placeholder: 'localhost or ${vault.db_host}',
        supportsExpressions: true,
      },
    ...
    outputSchema: [
      { name: 'connected', type: 'boolean', description: 'Connection status' },
      {
        name: 'connectionId',
        type: 'string',
        description: 'Connection identifier for use in subsequent nodes',
      },
    ...
    configSchema: [
      {
        ...
        label: 'Connection',
        type: 'text',
        placeholder: '${Connect Database.connectionId}',
        supportsExpressions: true,
      },
      {
        name: 'query',
  ...
  },
  {
    ...
    outputSchema: [{ name: 'rowsAffected', type: 'number', description: 'Number of rows updated' }],
  },
  {
    ...
    outputSchema: [{ name: 'rowsAffected', type: 'number', description: 'Number of rows deleted' }],
  },
  {
  ...
  // Connect AI Model node to configure the LLM provider
  {
    ...
    label: 'AI Agent',
    description:
      'Autonomous ReAct agent with tool execution. Connect an AI Model node to configure the LLM.',
    icon: 'BrainCircuit',
  ...
  },
  {
    ...
    configSchema: [
      ...
      },
      {
        ...
        type: 'textarea',
        required: true,
        placeholder: '{"name": "string", "email": "string", "amount": "number"}',
      },
      {
        name: 'instructions',
        label: 'Additional Instructions',
        type: 'textarea',
        placeholder: 'Optional extraction hints...',
      },
      // Note: LLM is configured via connected "AI Model" node (ai.model) → Model handle
    ],
    outputSchema: [
  ...
  },
  {
    ...
    outputSchema: [{ name: 'summary', type: 'string', description: 'Summarized text' }],
  },
  {
    type: 'ai.classify',
    category: 'ai',
  ...
  },
  {
    ...
    description:
      'Intelligently repair data quality issues. Connect AI Model node to configure LLM.',
    icon: 'Wrench',
    defaultConfig: {
      context: 'general',
    ...
    configSchema: [
      ...
      {
        name: 'allow_format_normalization',
        label: 'Allow Format Normalization',
        type: 'boolean',
        default: true,
      },
      {
        name: 'allow_semantic_cleanup',
        label: 'Allow Semantic Cleanup',
        type: 'boolean',
        default: true,
      },
      {
        name: 'allow_value_inference',
        label: 'Allow Value Inference (CAUTION)',
        type: 'boolean',
        default: false,
      },
      {
        name: 'allow_sensitive_repair',
        label: 'Allow Sensitive Field Repair',
        type: 'boolean',
        default: false,
      },
      {
    ...
    outputSchema: [
      {
        name: 'status',
        type: 'string',
        description: 'Result status: repaired, partially_fixed, failed',
      },
      ...
      { name: 'repaired_data', type: 'array', description: 'Data with applied repairs' },
      {
        name: 'repairs',
        type: 'array',
        description: 'List of applied repairs with confidence scores',
      },
  ...
  },
  {
    ...
    outputSchema: [
      { name: 'suggestion_count', type: 'number', description: 'Total number of suggestions' },
      {
        ...
        type: 'array',
        description: 'High confidence suggestions (>= 0.9)',
      },
      {
        name: 'medium_confidence',
        type: 'array',
        description: 'Medium confidence suggestions (0.7-0.9)',
      },
      { name: 'low_confidence', type: 'array', description: 'Low confidence suggestions (< 0.7)' },
      {
        name: 'estimated_quality_after_repair',
        type: 'number',
        description: 'Estimated quality if all repairs applied',
      },
    ],
  },
  ...
  // ──────────────────────────────────────────────────
  {
    ...
    configSchema: [
      ...
      },
      {
        ...
        type: 'number',
        default: 1536,
        placeholder: '1536 for OpenAI, 768 for BERT',
      },
      {
  ...
  },
  {
    ...
    configSchema: [
      {
        ...
        required: true,
        supportsExpressions: true,
        placeholder: '${pgvector Connect.connection_id}',
      },
      // Data Input - supports multiple formats
      {
        ...
        required: true,
        supportsExpressions: true,
        placeholder: 'JSON array of vectors or ${Generate Embeddings.embeddings}',
      },
      {
        name: 'documents',
        label: 'Documents/Content (optional)',
        type: 'textarea',
        supportsExpressions: true,
        placeholder: 'Original text content for retrieval',
      },
      {
        name: 'metadata',
        label: 'Metadata',
        type: 'textarea',
        supportsExpressions: true,
        placeholder: 'JSON array of metadata objects',
      },
      {
        name: 'ids',
        label: 'IDs (optional)',
        type: 'textarea',
        supportsExpressions: true,
        placeholder: 'Auto-generated UUIDs if empty',
      },
      // Batch Processing
      ...
      // Metadata columns to update on conflict
      {
        ...
        label: 'Update Metadata on Conflict',
        type: 'boolean',
        default: true,
      },
    ...
    outputSchema: [
      ...
      { name: 'updated_count', type: 'number', description: 'Number of vectors updated' },
      {
        name: 'skipped_count',
        type: 'number',
        description: 'Number of vectors skipped (duplicates)',
      },
  ...
  },
  {
    ...
    configSchema: [
      ...
      // Query Input - vector or text (auto-embed)
      {
        ...
        type: 'textarea',
        supportsExpressions: true,
        placeholder: '${Generate Embeddings.embedding}',
      },
      {
        name: 'query_text',
        label: 'OR Query Text (auto-embed)',
        type: 'textarea',
        supportsExpressions: true,
      ...
      },
      {
        ...
        label: 'Embedding Model (for text)',
        type: 'select',
      ...
      },
      {
        ...
        type: 'number',
        default: 0,
        placeholder: '0 = return all',
      },
      // Filtering
      {
        name: 'filter',
        label: 'Metadata Filter (SQL WHERE)',
        type: 'textarea',
        supportsExpressions: true,
        placeholder: "category = 'docs' AND created_at > '2024-01-01'",
      },
      {
        name: 'filter_json',
        label: 'OR Filter (JSON)',
        type: 'textarea',
        supportsExpressions: true,
        placeholder: '{"category": "docs", "status": "active"}',
      },
      // Output Options
    ...
    outputSchema: [
      {
        name: 'results',
        type: 'array',
        description: 'Array of {id, score, metadata, document, vector}',
      },
  ...
  },
  {
    ...
    configSchema: [
      ...
      },
      {
        ...
        type: 'textarea',
        supportsExpressions: true,
        placeholder: "expires_at < NOW() OR status = 'archived'",
      },
      {
        name: 'filter_json',
        label: 'OR Filter (JSON)',
      ...
      {
        name: 'confirm_delete',
        label: 'Confirm Delete (set false for scripts)',
        type: 'boolean',
        default: true,
      },
      {
        name: 'dry_run',
        label: 'Dry Run (count without deleting)',
        type: 'boolean',
        default: false,
      },
    ],
    outputSchema: [
      { name: 'deleted_count', type: 'number', description: 'Number of vectors deleted' },
      {
        name: 'would_delete',
        type: 'number',
        description: 'Count of vectors that would be deleted (dry run)',
      },
  ...
  // ──────────────────────────────────────────────────
  {
    ...
    configSchema: [
      ...
      },
      {
        ...
        type: 'text',
        required: true,
        placeholder: 'us-east-1-aws or gcp-starter',
      },
      { name: 'index_name', label: 'Index Name', type: 'text', required: true },
      {
        name: 'namespace',
        label: 'Namespace (multi-tenant isolation)',
        type: 'text',
        supportsExpressions: true,
      },
      // Auto-create index if not exists
      {
        ...
        label: 'Create Index if Not Exists',
        type: 'boolean',
        default: false,
      },
      ...
      {
        name: 'metric',
        label: 'Distance Metric (for create)',
        type: 'select',
        default: 'cosine',
        options: [
  ...
  },
  {
    ...
    configSchema: [
      ...
      {
        name: 'sparse_vectors',
        label: 'Sparse Vectors (hybrid search)',
        type: 'textarea',
        supportsExpressions: true,
      },
      // Batch settings
      ...
      {
        name: 'async_mode',
        label: 'Async Mode (faster, no confirmation)',
        type: 'boolean',
        default: false,
      },
    ],
  ...
  // ──────────────────────────────────────────────────
  {
    ...
    configSchema: [
      // Connection
      {
        ...
        type: 'text',
        required: true,
        placeholder: 'http://localhost:6333 or https://xxx.qdrant.io',
      },
      {
        name: 'api_key',
        label: 'API Key (Qdrant Cloud)',
        type: 'password',
        supportsExpressions: true,
      },
  ...
  },
  {
    ...
    configSchema: [
      ...
      {
        name: 'payloads',
        label: 'Payloads (metadata)',
        type: 'textarea',
        supportsExpressions: true,
      },
      {
        name: 'ids',
        label: 'IDs (optional, auto-UUID)',
        type: 'textarea',
        supportsExpressions: true,
      },
      ...
      {
        name: 'vector_name',
        label: 'Vector Name (multi-vector)',
        type: 'text',
  ...
  },
  {
    ...
    configSchema: [
      ...
      // Filtering (Qdrant's powerful filter syntax)
      {
        ...
        type: 'textarea',
        supportsExpressions: true,
        placeholder: '{"must": [{"key": "category", "match": {"value": "docs"}}]}',
      },
      // Output
  ...
  },
  {
    ...
    configSchema: [
      ...
      {
        name: 'ids',
        label: 'IDs (auto-generated if empty)',
        type: 'textarea',
        supportsExpressions: true,
      },
      ...
      {
        name: 'embeddings',
        label: 'Embeddings (skip auto-embed)',
        type: 'textarea',
        supportsExpressions: true,
      },
    ],
  ...
  },
  {
    ...
    outputSchema: [{ name: 'updated_count', type: 'number', description: 'Documents updated' }],
  },
  {
    ...
    outputSchema: [{ name: 'deleted_count', type: 'number', description: 'Documents deleted' }],
  },
    ...
    configSchema: [
      {
        ...
        required: true,
        supportsExpressions: true,
        placeholder: '[{"id": "doc1", "content": "...", "metadata": {...}}]',
      },
    ...
    outputSchema: [
      {
        name: 'results',
        type: 'array',
        description: 'Search results with id, score, content, metadata',
      },
      { name: 'count', type: 'number', description: 'Number of results' },
    ],
  },
  {
    ...
    configSchema: [
      ...
      {
        name: 'filter_metadata',
        label: 'OR Metadata Filter',
        type: 'textarea',
        supportsExpressions: true,
      },
      { name: 'delete_all', label: 'Delete ALL (danger)', type: 'boolean', default: false },
    ],
    outputSchema: [{ name: 'deleted', type: 'number', description: 'Documents deleted' }],
  },
  {
  ...
  // ──────────────────────────────────────────────────
  {
    ...
    label: 'Vector Memory',
    description:
      "Vector store memory for AI Agent (automatic RAG). Connect to AI Agent's Memory input.",
    icon: 'Brain',
    defaultConfig: {
      provider: 'chroma',
    ...
    configSchema: [
      ...
      {
        name: 'persist_directory',
        label: 'Persist Directory (ChromaDB)',
        type: 'text',
        placeholder: './chroma_data',
        visibleWhen: { field: 'provider', value: 'chroma' },
      },
      // pgvector settings (shown when provider=pgvector)
      {
        ...
        type: 'text',
        default: 'localhost',
        visibleWhen: { field: 'provider', value: 'pgvector' },
      },
      {
        name: 'port',
        label: 'Port',
      ...
      // Supabase settings (shown when provider=supabase)
      {
        ...
        type: 'text',
        placeholder: 'https://xxx.supabase.co',
        visibleWhen: { field: 'provider', value: 'supabase' },
      },
      {
        name: 'api_key',
      ...
      // Pinecone settings (shown when provider=pinecone)
      {
        ...
        type: 'text',
        secret: true,
        visibleWhen: { field: 'provider', value: 'pinecone' },
      },
      {
        name: 'index_name',
        label: 'Index Name',
      ...
      // Qdrant settings (shown when provider=qdrant)
      {
        ...
        type: 'text',
        default: 'localhost',
        visibleWhen: { field: 'provider', value: 'qdrant' },
      },
      {
        name: 'port',
        label: 'Port',
    ...
    configSchema: [
      {
        ...
        required: true,
        supportsExpressions: true,
        placeholder: '${Load Documents.documents}',
      },
      {
        name: 'model',
        label: 'Embedding Model',
  ...
  // ──────────────────────────────────────────────────
  {
    ...
    configSchema: [
      ...
      // OpenAI models
      {
        ...
        type: 'select',
        default: 'text-embedding-3-small',
        visibleWhen: { field: 'provider', value: 'openai' },
        options: [
          { value: 'text-embedding-3-small', label: 'text-embedding-3-small (1536d, fastest)' },
          {
            value: 'text-embedding-3-large',
            label: 'text-embedding-3-large (3072d, best quality)',
          },
      ...
      // Azure OpenAI
      {
        ...
        type: 'text',
        visibleWhen: { field: 'provider', value: 'azure' },
      ...
      // Ollama (Local)
      {
        ...
        label: 'Model',
        type: 'select',
        visibleWhen: { field: 'provider', value: 'ollama' },
        options: [
      ...
      // Cohere
      {
        ...
        label: 'Model',
        type: 'select',
        visibleWhen: { field: 'provider', value: 'cohere' },
        options: [
      ...
      // HuggingFace
      {
        ...
        label: 'Model ID',
        type: 'text',
        visibleWhen: { field: 'provider', value: 'huggingface' },
      ...
      {
        name: 'base_url',
        label: 'Inference Endpoint (optional)',
        type: 'text',
        visibleWhen: { field: 'provider', value: 'huggingface' },
      ...
      {
        name: 'api_key',
        label: 'Google API Key / Service Account',
        type: 'text',
        secret: true,
        visibleWhen: { field: 'provider', value: 'google' },
      },
      ...
      // AWS Bedrock
      {
        ...
        label: 'Model',
        type: 'select',
        visibleWhen: { field: 'provider', value: 'aws' },
        options: [
      ...
      {
        name: 'dimension',
        label: 'Vector Dimension (auto-detected)',
        type: 'number',
        default: 1536,
      },
      { name: 'batch_size', label: 'Batch Size', type: 'number', default: 100 },
  ...
  // ──────────────────────────────────────────────────
  {
    ...
    configSchema: [
      ...
      // Anthropic models
      {
        ...
        visibleWhen: { field: 'provider', value: 'anthropic' },
        options: [
      ...
      // Groq
      {
        ...
        label: 'Model',
        type: 'select',
        visibleWhen: { field: 'provider', value: 'groq' },
        options: [
      ...
      // Mistral AI
      {
        ...
        label: 'Model',
        type: 'select',
        visibleWhen: { field: 'provider', value: 'mistral' },
        options: [
      ...
      },
      {
        ...
        label: 'Custom Model',
        type: 'text',
        visibleWhen: { field: 'model', value: 'custom' },
  ...
  // ============================================
  {
    ...
    description:
      'Execute custom JavaScript code with reusable functions. Access input data via $input, return result.',
    icon: 'Braces',
...
// };`,
  ...
  },
  {
    ...
    label: 'Code (Python)',
    description:
      'Execute custom Python code with reusable functions. Access input data via input_data, return via result.',
    icon: 'FileCode2',
    defaultConfig: { mode: 'runOnceForAll', functions: '', code: '' },
    configSchema: [
      {
...
# }`,
    ...
    outputSchema: [
      {
        name: 'data',
        type: 'any',
        description: 'Output data returned from the code (result variable)',
      },
      { name: 'itemCount', type: 'number', description: 'Number of items returned' },
      { name: 'executionTime', type: 'number', description: 'Execution time in milliseconds' },
    ],
  ...
  },
  {
    ...
    description:
      'Execute external Python project (like ElectroNeek). Supports venv, JSON input via file or env, captures stdout as output.',
    icon: 'FolderCode',
    ...
    configSchema: [
      {
        ...
        description: 'Absolute path to the Python project folder',
      },
      {
        name: 'entrypoint',
        ...
        required: true,
        placeholder: 'main.py',
        description: 'Python file to execute (relative to project path)',
      },
      {
        name: 'venv_path',
        ...
        description: 'Path to venv folder (relative or absolute). Leave empty for system Python.',
      },
      {
        name: 'args',
        label: 'Script Arguments',
        type: 'text',
        placeholder: '--verbose --config settings.json',
        description: 'Command line arguments (access via sys.argv)',
      },
      {
        name: 'input_method',
        label: 'Input Data Method',
        type: 'select',
        default: 'env',
        options: [
      ...
      { name: 'pass_input', label: 'Pass Input Data', type: 'boolean', default: true },
      {
        ...
        type: 'boolean',
        default: true,
        description: 'Parse stdout as JSON. If false, returns raw string.',
      },
      {
        name: 'timeout',
        label: 'Timeout (seconds)',
    ...
    outputSchema: [
      {
        name: 'output',
        type: 'any',
        description: 'Parsed JSON from stdout, or raw string if not JSON',
      },
  ...
  },
  {
    ...
    configSchema: [
      ...
      },
      {
        ...
        type: 'text',
        placeholder: 'python3 or /usr/bin/python3.11',
        description: 'Leave empty for default python3',
      },
      {
        ...
        description: 'Space-separated packages to install after creation',
      },
      {
    ...
    outputSchema: [
      ...
      { name: 'created', type: 'boolean', description: 'True if venv was created successfully' },
      {
        ...
        type: 'boolean',
        description: 'True if packages were installed',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    label: 'Run Notebook',
    description:
      'Execute Jupyter notebook with papermill. Pass parameters, capture outputs, use custom kernels.',
    icon: 'BookOpen',
  ...
  "mode": "production"
    ...
    outputSchema: [
      ...
      },
      {
        name: 'cellOutputs',
        type: 'object',
        description: "Outputs from cells tagged with 'skuld_output'",
      },
  ...
  },
  {
    ...
    icon: 'Calculator',
    defaultConfig: {},
    configSchema: [{ name: 'expression', label: 'Expression', type: 'text', required: true }],
  },
  ...
  // === CONTAINER NODES (rendered as GroupNode) ===
  {
    ...
    label: 'If Condition',
    description:
      'Container: branch based on condition. Drag nodes inside to execute when condition is true.',
    icon: 'GitBranch',
    defaultConfig: {},
    configSchema: [
      {
    ...
    outputSchema: [{ name: 'result', type: 'boolean', description: 'Condition evaluation result' }],
  },
  {
    type: 'control.switch',
    category: 'control',
    ...
    outputSchema: [{ name: 'matched_case', type: 'string', description: 'Which case was matched' }],
  },
  {
    type: 'control.loop',
    category: 'control',
    label: 'For Each',
    description:
      "Container: iterate over a collection. Drag nodes inside to process each item. Use 'done' output to continue after loop completes.",
    icon: 'Repeat',
    ...
    configSchema: [
      ...
      {
        name: 'item_var',
        label: 'Item Variable Name (access as ${item})',
        type: 'text',
        default: 'item',
        placeholder: 'item',
      },
      {
        ...
        label: 'Accumulator Variable (use control.append)',
        type: 'text',
        default: 'results',
        placeholder: 'results',
      },
    ...
    outputSchema: [
      ...
      { name: 'isLast', type: 'boolean', description: 'True if last iteration' },
      {
        name: 'results',
        type: 'array',
        description: 'Accumulated results array (available after loop completes)',
      },
  ...
  },
  {
    ...
    label: 'While Loop',
    description:
      "Container: loop while condition is true. Use 'done' output to continue after loop ends.",
    icon: 'RefreshCw',
    ...
    outputSchema: [
      ...
      },
      {
        name: 'exit_reason',
        type: 'string',
        description: "Why loop exited: 'condition_false' | 'max_iterations' | 'break'",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    configSchema: [
      ...
      },
      {
        ...
        type: 'textarea',
        required: true,
        placeholder: '${some_value} or literal',
        supportsExpressions: true,
      },
      {
        name: 'scope',
  ...
  },
  {
    ...
    label: 'Try/Catch',
    description:
      'Container: handle errors gracefully. Drag nodes inside to execute with error handling.',
    icon: 'ShieldAlert',
  ...
  },
  {
    ...
    icon: 'GitBranch',
    defaultConfig: {},
    configSchema: [{ name: 'branches', label: 'Number of Branches', type: 'number', default: 2 }],
  },
  {
    type: 'control.stop',
    category: 'control',
  ...
  },
  {
    ...
    defaultConfig: {},
    configSchema: [{ name: 'target_node', label: 'Target Node ID', type: 'text', required: true }],
  },
  {
    type: 'control.map',
    category: 'control',
    ...
    configSchema: [
      ...
      },
      {
        ...
        type: 'textarea',
        required: true,
        placeholder: "{ id: ${item.id}, fullName: ${item.first} + ' ' + ${item.last} }",
        supportsExpressions: true,
      },
      {
        name: 'item_var',
  ...
  },
  {
    ...
    configSchema: [
      ...
      {
        name: 'item',
        label: 'Item to Append',
        type: 'textarea',
        required: true,
        placeholder: '${transformed_item}',
        supportsExpressions: true,
      },
    ],
    outputSchema: [
  ...
  // --- Call Bot (Invoke Subworkflow) ---
  {
    ...
    label: 'Call Bot',
    description:
      'Invoke another bot as a subprocess, passing parameters and receiving results. Enables modular, reusable automation design.',
    icon: 'Package',
    defaultConfig: {
    ...
    configSchema: [
      // Bot selection
      {
        ...
        type: 'bot-select',
        required: true,
        description: 'Select a bot from this project',
      },
      ...
      // Input parameters (dynamic key-value)
      {
        ...
        supportsExpressions: true,
        description: 'JSON object with parameters to pass to the subbot',
      },
      ...
      // Execution mode
      {
        ...
        default: true,
        description:
          'Wait for subbot to finish (sync) or continue immediately (async/fire-and-forget)',
      },
      ...
      // Timeout & Retry (Enterprise)
      {
        ...
        type: 'number',
        default: 300,
        description: 'Max time to wait for subbot completion (0 = no timeout)',
      },
      {
        name: 'retry_count',
        ...
        type: 'number',
        default: 0,
        description: 'Number of retry attempts if subbot fails',
      },
      {
        ...
        type: 'number',
        default: 5,
        visibleWhen: { field: 'retry_count', value: ['1', '2', '3', '4', '5'] },
        description: 'Seconds between retry attempts (exponential backoff applied)',
      },
      ...
      // Error handling
      {
        ...
        type: 'boolean',
        default: true,
        description: 'Stop parent bot if subbot fails',
      },
      ...
      // Advanced
      {
        ...
        description: 'Prefix for subbot execution ID (for tracking)',
      },
      {
        ...
        type: 'boolean',
        default: false,
        description: "Pass parent's vault/env to subbot",
      },
    ],
    outputSchema: [
      {
        name: 'result',
        type: 'object',
        description: 'Return value from subbot (from bot.output node)',
      },
  ...
  // --- Bot Input (Define Subbot Parameters) ---
  {
    ...
    label: 'Bot Input',
    description:
      'Define input parameters for this bot when called as a subprocess. Use this instead of a trigger when the bot is meant to be called by other bots.',
    icon: 'LogIn',
    ...
    configSchema: [
      // Parameter definitions
      {
        ...
        description:
          'JSON array defining expected parameters: name, type, required, default, description',
      },
      ...
      // Validation
      {
        ...
        type: 'boolean',
        default: true,
        description: 'Validate parameter types and required fields',
      },
      {
        name: 'fail_on_invalid',
        label: 'Fail on Invalid Input',
        type: 'boolean',
        default: true,
    ...
    outputSchema: [
      { name: 'params', type: 'object', description: 'All received parameters as an object' },
      {
        name: 'caller_bot_id',
        type: 'string',
        description: 'ID of the bot that called this subbot',
      },
      {
        name: 'caller_execution_id',
        type: 'string',
        description: 'Execution ID of the parent bot',
      },
  ...
  // --- Bot Output (Return from Subbot) ---
  {
    ...
    label: 'Bot Output',
    description:
      "Define what this bot returns when called as a subprocess. The return value is available in the calling bot's bot.call output.",
    icon: 'LogOut',
    ...
    configSchema: [
      // Return value
      {
        ...
        supportsExpressions: true,
        description: 'JSON object to return to the calling bot',
      },
      ...
      // Optional message
      {
        ...
        type: 'text',
        placeholder: 'Processed ${count} items successfully',
        supportsExpressions: true,
  ...
  // --- Bot Queue (Async Batch Processing) ---
  {
    ...
    description:
      'Queue multiple bot calls for async/parallel execution. Process items in batches with concurrency control.',
    icon: 'ListTodo',
    defaultConfig: {
      concurrency: 3,
      fail_fast: false,
    ...
    configSchema: [
      ...
      // Items to process
      {
        ...
        supportsExpressions: true,
        description: 'Array of items - each will be passed to a bot instance',
      },
      ...
      // Parameter mapping
      {
        ...
        placeholder: '{\n  "invoice_id": "${item.id}",\n  "amount": "${item.total}"\n}',
        supportsExpressions: true,
        description: 'Map item fields to bot parameters (use ${item} for current item)',
      },
      ...
      // Concurrency
      {
        ...
        type: 'number',
        default: 3,
        description: 'Max parallel bot executions (1-10)',
      },
      ...
      // Error handling
      {
        ...
        type: 'boolean',
        default: false,
        description: 'Stop all on first failure (vs. continue and collect errors)',
      },
      ...
      // Results
      {
        ...
        type: 'boolean',
        default: true,
        description: 'Gather all results into output array',
      },
    ...
    outputSchema: [
      ...
      { name: 'failed', type: 'number', description: 'Number of failed executions' },
      {
        name: 'errors',
        type: 'array',
        description: 'Array of errors (item index + error message)',
      },
  ...
  },
  {
    ...
    icon: 'Camera',
    defaultConfig: {},
    configSchema: [{ name: 'description', label: 'Description', type: 'text' }],
  },
  {
    type: 'logging.metric',
    category: 'logging',
  ...
  },
  {
    ...
    icon: 'Timer',
    defaultConfig: {},
    configSchema: [{ name: 'name', label: 'Timer Name', type: 'text', required: true }],
  },
  {
    ...
    configSchema: [
      {
        ...
        type: 'text',
        default: '.skuldbot',
        placeholder: '.skuldbot or /etc/skuldbot/vault',
      },
      {
        name: 'secrets',
        label: 'Secrets to Load (optional)',
        type: 'textarea',
        placeholder: 'db_password\napi_key',
      },
    ],
    ...
    configSchema: [
      {
        ...
        required: true,
        supportsExpressions: true,
        placeholder: '${previous_node.records}',
      },
  ...
  },
  {
    ...
    outputSchema: [
      { name: 'protected_data', type: 'object', description: 'Data with protected PHI fields' },
      {
        ...
        type: 'boolean',
        description: 'Whether result is HIPAA compliant',
      },
      { name: 'fields_processed', type: 'number', description: 'Number of fields processed' },
      {
        name: 'hipaa_identifiers_protected',
        type: 'array',
        description: 'List of HIPAA 18 identifiers that were protected',
      },
      { name: 'audit_log', type: 'array', description: 'Audit log of all protection operations' },
    ],
  },
  ...
  // --- UTILITY NODES ---
  {
    ...
    outputSchema: [
      ...
      { name: 'column_count', type: 'number', description: 'Total number of columns' },
      {
        name: 'columns',
        type: 'object',
        description: 'Column-by-column statistics (nulls, types, unique values)',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    configSchema: [
      ...
      },
      {
        ...
        label: 'SQL Query',
        type: 'textarea',
        placeholder: 'SELECT * FROM customers WHERE ROWNUM <= 1000',
      },
  ...
  // --- SAAS TAPS ---
  {
    ...
    configSchema: [
      ...
      },
      {
        ...
        type: 'textarea',
        required: true,
        placeholder: 'SELECT Id, Name, Email FROM Contact WHERE CreatedDate > LAST_MONTH',
      },
      {
        name: 'domain',
        label: 'Domain',
  ...
  },
  {
    ...
    configSchema: [
      ...
      },
      {
        ...
        label: 'Pagination Param',
        type: 'text',
        placeholder: 'offset or page or cursor',
      },
      {
        name: 'data_path',
  ...
  // --- DATABASE TARGETS (Loaders) ---
  {
    ...
    configSchema: [
      ...
      { name: 'table', label: 'Target Table', type: 'text', required: true },
      {
        ...
        required: true,
        supportsExpressions: true,
        placeholder: '${Extract SQL Server.records}',
      },
      {
        name: 'mode',
        label: 'Mode',
  ...
  // --- FILE TARGETS ---
  {
    ...
    outputSchema: [{ name: 'insertedCount', type: 'number', description: 'Records written' }],
  },
  {
  ...
  // --- CLOUD TARGETS ---
  {
    ...
    outputSchema: [{ name: 'insertedCount', type: 'number', description: 'Records uploaded' }],
  },
  {
  ...
  // --- VOICE ACTIONS ---
  {
    ...
    configSchema: [
      ...
      },
      {
        ...
        label: 'TwiML URL',
        type: 'text',
        placeholder: 'https://your-app.com/voice/script',
      },
      {
        name: 'twiml',
        label: 'TwiML (inline)',
  ...
  },
  {
    ...
    configSchema: [
      {
        ...
        type: 'password',
        required: true,
        placeholder: 'Your Azure Speech Services Key',
      },
      {
        name: 'azure_region',
        label: 'Azure Region',
    ...
    outputSchema: [
      ...
      { name: 'output_path', type: 'string', description: 'Path to audio file' },
      {
        name: 'audio_data',
        type: 'string',
        description: 'Base64 encoded audio (if no output_path)',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    outputSchema: [{ name: 'twiml', type: 'string', description: 'Generated TwiML' }],
  },
  {
    ...
    configSchema: [
      ...
      },
      {
        ...
        type: 'text',
        required: true,
        placeholder: 'https://your-app.com/process-input',
      },
      {
        name: 'input_type',
        label: 'Input Type',
  ...
  },
  {
    ...
    configSchema: [
      ...
      },
      {
        ...
        type: 'text',
        supportsExpressions: true,
        placeholder: 'Leave empty for current call',
      },
      {
    ...
    configSchema: [
      {
        ...
        label: 'Key',
        type: 'text',
        placeholder: 'Leave empty to get all context',
        supportsExpressions: true,
      },
    ],
    outputSchema: [
  ...
  },
  {
    ...
    configSchema: [
      {
        name: 'api_url',
        label: 'Policy Lookup API URL',
        type: 'text',
        required: true,
        placeholder: 'https://your-insurance-system.com/api/policies/lookup',
      },
      // Primary: CallerID from Twilio (automatic)
      {
        name: 'phone_number',
        label: 'Phone Number (from CallerID)',
        type: 'text',
        supportsExpressions: true,
        placeholder: '${Voice Trigger.caller_number}',
      },
    ...
    outputSchema: [
      ...
      { name: 'policyholder_name', type: 'string', description: 'Policyholder name' },
      {
        name: 'match_method',
        type: 'string',
        description: 'How policy was found (phone, name_dob, etc.)',
      },
  ...
  },
  {
    ...
    configSchema: [
      {
        name: 'api_url',
        label: 'Policy Validation API URL',
        type: 'text',
        required: true,
        placeholder: 'https://your-insurance-system.com/api/policies/validate',
      },
      {
        name: 'policy_id',
        label: 'Policy ID (from lookup)',
        type: 'text',
        supportsExpressions: true,
        placeholder: '${Lookup Policy.policy_id}',
      },
      {
        name: 'policy_number',
        label: 'Policy Number',
        type: 'text',
        supportsExpressions: true,
        placeholder: '${Lookup Policy.policy_number}',
      },
      {
        name: 'claim_type',
        label: 'Claim Type to Validate',
        type: 'select',
        options: [
          { value: 'auto', label: 'Auto/Vehicle' },
          { value: 'property', label: 'Property' },
  ...
  // --- MS365 Connection ---
  {
    ...
    configSchema: [
      ...
      },
      {
        ...
        required: true,
        supportsExpressions: true,
        placeholder: '${vault.ms365_secret}',
      },
      {
        name: 'user_email',
        ...
        type: 'text',
        placeholder: 'user@company.com',
        description: 'Email address for delegated access',
      },
    ],
    outputSchema: [
    ...
    configSchema: [
      {
        ...
        required: true,
        supportsExpressions: true,
        placeholder: 'from:john@example.com subject:urgent',
      },
      {
        name: 'folder',
        label: 'Folder',
    ...
    outputSchema: [
      {
        name: 'attachments',
        type: 'array',
        description: 'List of attachments with id, name, size, contentType',
      },
  ...
  },
  {
    ...
    configSchema: [
      ...
      },
      {
        ...
        type: 'boolean',
        default: false,
        description: 'If unchecked, moves to Deleted Items',
      },
    ],
    outputSchema: [
  ...
  },
  {
    ...
    configSchema: [
      ...
      },
      {
        ...
        required: true,
        supportsExpressions: true,
        placeholder: 'Important, Client, Follow-up',
      },
    ],
    outputSchema: [
      { name: 'id', type: 'string', description: 'Message ID' },
    ...
    configSchema: [
      {
        ...
        type: 'text',
        supportsExpressions: true,
        placeholder: 'Leave empty for root folders',
      },
    ],
    outputSchema: [
      {
        name: 'folders',
        type: 'array',
        description: 'List of folders with id, displayName, totalItemCount, unreadItemCount',
      },
