...
export default function VaultManager() {
  ...
  const toggleSecretVisibility = () => {
    toast.info(
      'Security',
      'Secret values are not exposed to the UI. Use ${vault.name} in your bot to access them at runtime.',
    );
  };
        ...
        <div className="max-w-xl mx-auto p-6">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">Secure storage for credentials and secrets</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-6">
            <div className="space-y-4">
              ...
              <p className="text-sm text-slate-600">
                Click to initialize the local secrets vault. The vault is automatically encrypted
                using AES-256-GCM and managed by the Studio.
              </p>
          ...
          <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <h3 className="text-sm font-medium text-blue-800 mb-2">Using Secrets in Bots</h3>
            ...
            <p className="text-xs text-blue-600 mt-2">
              This local vault is for development and testing. In production, secrets are managed in
              the Orchestrator.
            </p>
          </div>
        </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-2">
                  <Button
                    ...
                    disabled={isLoading || !newSecret.name || !newSecret.value}
                  >
                    {isLoading ? (
                      <RefreshCw className="w-4 h-4 animate-spin" />
                    ) : (
          ...
          <div className="bg-white rounded-xl border border-slate-200">
            ...
            {secrets.length === 0 ? (
              <div className="p-8 text-center">
                ...
                <Button variant="outline" className="mt-4" onClick={() => setShowAddSecret(true)}>
                  <Plus className="w-4 h-4" />
                  Add First Secret
                </Button>
              </div>
                ...
                {secrets.map((secret) => (
                  ...
                  >
                    <div className="flex-1 min-w-0">
                      ...
                      {secret.description && (
                        <p className="text-sm text-slate-500 mt-1 truncate">{secret.description}</p>
                      )}
