      ...
      <div className="text-center max-w-2xl px-8">
        ...
        <div className="relative inline-flex items-center justify-center mb-8">
          <div
            ...
            style={{
              background:
                'linear-gradient(to bottom right, rgba(0, 163, 108, 0.2), rgba(80, 200, 120, 0.2))',
            }}
          />
          <div
            className="absolute w-24 h-24 rounded-full blur-xl animate-pulse"
            style={{ backgroundColor: 'rgba(0, 163, 108, 0.1)' }}
          />
        ...
        {/* Title */}
        <h2 className="text-2xl font-bold text-foreground mb-3">Build Your Automation</h2>

        <p className="text-sm text-muted-foreground leading-relaxed mb-10 max-w-md mx-auto">
          Create powerful RPA workflows with AI-powered agents. Drag components from the library to
          get started.
        </p>
        ...
        <div className="grid grid-cols-3 gap-3 mb-10">
          {quickStartItems.map((item) => (
            ...
            >
              <div
                className={`w-9 h-9 rounded-lg ${item.bg} ${item.color} flex items-center justify-center mb-3`}
              >
