...
import { Play, CheckCircle, AlertCircle, ChevronRight, Eye, Download, FolderPlus } from "lucide-react";
...
export function PreviewPanel() {
  const { currentPlan, confidence, applyToCanvas, applyAsProject } = useAIPlannerV2Store();
