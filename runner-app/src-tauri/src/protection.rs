...
#[tauri::command]
pub fn validate_license(license_key: String) -> Result<License, String> {
...
#[tauri::command]
pub fn check_license_status() -> Result<serde_json::Value, String> {
    // Load stored license and check validity
    Ok(serde_json::json!({
        "valid": true,
        "type": "trial",
        "expires_in_days": 30,
...
pub fn get_machine_fingerprint() -> String {
    let _storage = SecureStorage::new();
